...
@app.route("/rent-home-details")
def rent_home_details():
    return render_template('rent-home-details.html')

@app.route("/mortgage")
def mortgage():
    return render_template('mortgage.html')

@app.route("/mortgage-home-details")
def mortgage_home_details():
    return render_template('mortgage-home-details.html')
...
@app.route("/create-agency")
def create_agency():
    return render_template('create-agency.html')
